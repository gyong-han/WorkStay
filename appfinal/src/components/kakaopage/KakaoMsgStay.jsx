      ...
      data: {
        template_object: {
          ...
          content: {
            ...
            link: {
              web_url: `${BASE_URL3}/hostMenu/staydetail?reno=${vo.reservationNo}`, // 웹 링크
              mobile_web_url: `${BASE_URL3}/hostMenu/staydetail?reno=${vo.reservationNo}`,
            },
          },
          buttons: [
            {
              title: "결제내역 확인하기",
              link: {
                web_url: `${BASE_URL3}/hostMenu/staydetail?reno=${vo.reservationNo}`,
                mobile_web_url: `${BASE_URL3}/hostMenu/staydetail?reno=${vo.reservationNo}`,
              },
            },
          ],

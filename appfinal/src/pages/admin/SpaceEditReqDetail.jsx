...
const SpaceEditReqDetail = () => {
  ...
  const [editSpaceVo, setEditSpaceVo] = useState({});
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/api/admin/spaceEditReqDetail`, {
      method: "POST",
      headers: {
  ...
  const approve = () => {
    fetch(`${BASE_URL}/api/admin/approveEditSpace`, {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
  ...
  const companion = () => {
    fetch(`${BASE_URL}/api/admin/companionEditSpace`, {
      method: "POST",
      headers: {
        "content-type": "application/json",
      },
...
export default SpaceEditReqDetail;

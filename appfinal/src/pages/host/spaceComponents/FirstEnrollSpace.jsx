  ...
  return (
    <>
      ...
      <TagDiv>
        ...
        <p>
          우리는 공간의 가격이나 규모만이 아닌, 디자인, 운영 철학, 지역적 매력,{" "}
          <br />
          그리고 창의성을 기반으로 특별한 개성을 지닌 워케이션 공간을
          선별합니다.
        </p>
        <p>
          하나의 영감을 주는 제안은 하듯, 전 세계 곳곳의 숨겨진 워케이션에
          최적화된 숙소와 공간을 소개하고 연결하며, <br />그 안에 담긴 이야기와
          가능성을 탐험자들에게 전달합니다.
        </p>
        <p>
          워크스테이는 단순한 일터를 넘어 새로운 아이디어와 에너지를 충전할 수
          있는 창조적인 공간들을 제공합니다.
        </p>
      </TagDiv>
      <Hr />
...
export default FirstEnrollSpace;

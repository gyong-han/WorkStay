...
const FindSpaceDetail = () => {
  ...
  const spaceName="인터플럼";
  const spaceAdress="서울특별시 강남구 테헤란로 130";
  ...
  return (
    <Layout>
      ...
      <div>
        <div></div>
        <div>
          {spaceName}의 위치는 [{spaceAdress}]입니다.
          <br></br>
          {parking}
        </div>
        <div></div>
      </div>
      <div><Map spaceAdress={spaceAdress} spaceName={spaceName}> space</Map></div>
      <div></div>

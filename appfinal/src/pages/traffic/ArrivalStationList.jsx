...
const ArrivalStationList = () => {
  ...
  const stationClick = (station) => {
    dispatch(selectEndStation(station));
    ModalClose();
  };
  ...
  return (
    <div>
      <OpenButton onClick={ModalOpen}>
        {selectedEndStation ? selectedEndStation : "도착역 선택"}
      </OpenButton>

      <ModalBackground show={showModal}>
        <ModalContainer>
          <Header>도착역 선택</Header>
          <StationGrid>
...
export default ArrivalStationList;
